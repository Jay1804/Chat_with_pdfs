...
# Configure API key for Google Gemini API
...
def user_input(user_question):
    ...
    # Load the saved FAISS vector store, allowing dangerous deserialization
...
# Main function to set up Streamlit UI and process user queries
def main():
